...
const createTransporter = async () => {
    ...
    // Verify connection early (important for serverless)
...
router.post("/welcome", async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto;">
                    <h1 style="color:#4F46E5;">Welcome to PrismMinds!</h1>
                    <p>Hi ${userName},</p>
                    <p>We're excited to have you onboard 🚀</p>
                    <a href="https://prismminds.vercel.app/dashboard"
                       style="display:inline-block;padding:12px 20px;background:#4F46E5;color:#fff;text-decoration:none;border-radius:5px;">
        ...
        console.error("❌ Welcome email error FULL:", error);
        res.status(500).json({
