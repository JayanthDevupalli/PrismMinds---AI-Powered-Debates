    ...
    <>
      ...
      <main ref={containerRef} className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/20 dark:from-slate-950 dark:via-indigo-950/40 dark:to-slate-900 text-gray-800 dark:text-gray-200 font-['Inter',sans-serif]">
        ...
        <div className="relative z-10 px-4 sm:px-10 lg:px-20 py-6 sm:py-8">
          ...
          <footer className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center py-8 px-6 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-800 mt-20">
            <p>&copy; {new Date().getFullYear()} PrismMinds</p>
            <div className="flex gap-6 mt-4 sm:mt-0">
              <Link href="/privacy" className="hover:text-rose-500 transition">Privacy Policy</Link>
              <Link href="/terms" className="hover:text-rose-500 transition">Terms of Service</Link>
            </div>
          </footer>
        </div>
      </main >
