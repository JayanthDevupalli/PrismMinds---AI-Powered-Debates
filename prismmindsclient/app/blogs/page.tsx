...
//         {/* Animated orbs with purple and gold */}
...
//               {/* Content Overlay */}
//               <div className="absolute left-0 bottom-0 right-0 p-8 sm:p-10 flex flex-col gap-4">
//                 <div>
//                   <span
//                     className={`inline-flex items-center gap-2 ${featured.tagColor} rounded-full px-3 py-1 text-xs font-bold backdrop-blur-sm`}
//                   >
//                     {featured.tag}
//                   </span>
//                 </div>
//                 <div>
//                   <h3 className="text-3xl sm:text-4xl font-bold text-white mb-3 leading-tight group-hover:text-accent transition-colors">
//                     {featured.title}
//                   </h3>
//                   <p className="max-w-2xl text-base text-white/85 line-clamp-2">{featured.description}</p>
//                 </div>
...
//                   className="object-cover group-hover:scale-110 transition-transform duration-700"
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-background/40 opacity-0 group-hover:opacity-100 transition-opacity" />
...
//                 {/* Description */}
//                 <p className="text-sm text-muted-foreground line-clamp-2 flex-grow">{blog.description}</p>
